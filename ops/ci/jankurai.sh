...
cat > target/jankurai/ux-qa.json <<'JSON'
{"repo":"jmcp-deploy","owned_surface":"split launch, health, smoke, and mirror orchestration","delegated_repo":"jmcp-web","status":"not_applicable"}
JSON
